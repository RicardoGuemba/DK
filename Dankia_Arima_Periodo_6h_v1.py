...
interval_df = produto_df.resample('6H').sum()  # Resample para períodos de 6 horas e somar os valores
...
# Previsões para os próximos 4 períodos de 6 horas
forecast_steps = 4
...
# Apresentação dos últimos 8 valores
print("Últimos 8 valores:")
print(demand_series.tail(8))
